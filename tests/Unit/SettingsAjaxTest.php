...
final class SettingsAjaxTest extends TestCase {
	...
	protected function setUp(): void {
		...
		$GLOBALS['__x402_pay_json_error']          = null;
		$GLOBALS['__x402_pay_json_error_status_code'] = 0;
	...
	public function test_oversized_fields_payload_is_rejected_before_decode(): void {
		...
		$this->assertNull( $GLOBALS['__x402_pay_json_success'] );
		$this->assertSame( 'fields_too_large', $GLOBALS['__x402_pay_json_error']['error'] ?? '' );
		$this->assertSame( 413, $GLOBALS['__x402_pay_json_error_status_code'] );
	}
	...
	public function test_unregistered_facilitator_slots_are_dropped(): void {
		...
		$data = $GLOBALS['__x402_pay_json_success'];
		$this->assertArrayHasKey( 'x402_pay_test', $data['values']['facilitators'] );
