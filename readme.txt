...
The plugin is inert until you pick a paywall mode in **Settings → Simple x402**. The default mode is "No posts," so installing the plugin alone does not gate anything or contact any external service.
